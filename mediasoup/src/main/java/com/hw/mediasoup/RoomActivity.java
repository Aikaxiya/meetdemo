...
import com.hw.mediasoup.adapter.PeerAdapter;
import com.hw.mediasoup.databinding.ActivityRoomBinding;
...
import com.hw.mediasoup.lib.model.Me;
...
import static com.hw.mediasoup.lib.Utils.getRandomString;
import static com.hw.mediasoup.utils.ClipboardCopy.clipboardCopy;

@Route(path = "/mediasoup/RoomActivity")
public class RoomActivity extends AppCompatActivity {
  ...
  private void loadRoomConfig() {
    ...
    mRoomId = "77777";
    Log.e(TAG, "loadRoomConfig: "+mRoomId );
    // Room action config.
